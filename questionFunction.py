...
# Load images
images = {
    "center": pygame.transform.scale(pygame.image.load("csgameart.png"), (WIDTH, HEIGHT)),
    "up": pygame.transform.scale(pygame.image.load("up1cs.png"), (WIDTH, HEIGHT)),
    "down": pygame.transform.scale(pygame.image.load("down1cs.png"), (WIDTH, HEIGHT)),
    "left": pygame.transform.scale(pygame.image.load("left1cs.png"), (WIDTH, HEIGHT)),
    "right": pygame.transform.scale(pygame.image.load("right1cs.png"), (WIDTH, HEIGHT)),
}

# Start with the center image
current_bg = images["center"]

# Text Position and Speed
...
def draw_screen(question, user_input=''):
    ...
    # Position text
    question_rect = question_surface.get_rect(center=(text_x, text_y - 60 + text_offset_y))
    input_rect = input_surface.get_rect(center=(text_x, text_y + 30 + text_offset_y))
